    ...
    <div class="new-arrival">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-10">
                    <div class="col-12">
                        <h2 class="contact-title text-center">Grand livre</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                         ...
                         <tr>
                              ...
                              <th scope="col">Libelle ecriture</th>
                              <th scope="col">Reference(N° pièce)</th>
                         ...
                         <tbody>
                              <?php for($i = 0 ; $i < count($livre) ; $i++) { ?>
                                   <tr>
                                        <td><?php echo $livre[$i]['daty']; ?></td>
                                        <td><?php echo $livre[$i]['libelle']; ?></td>
                                        <td><?php echo $livre[$i]['refer']; ?></td>
                                        <td><?php echo $livre[$i]['compte']; ?></td>
                                        <td><?php echo $livre[$i]['debit']; ?></td>
                                        <td><?php echo $livre[$i]['credit']; ?></td>
                                        <td><?php echo $livre[$i]['quantite']; ?></td>        
                                        <td><?php echo $livre[$i]['devise']; ?></td>
                                   </tr>
                              <?php } ?>
                         </tbody>
                    </table>
